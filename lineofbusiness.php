				...
				<table id="user_data" class="table table-bordered table-striped">
					<thead>
						<tr>
							...
							<th width="35%">SubHeading</th>
							<th width="35%">Line Of Business</th>
							<th width="10%">Edit</th>
                    ...
                    <form method="post" id="user_form" enctype="multipart/form-data">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">Add LOB</h4>
                            </div>
                            <div class="modal-body">
                                <label>Enter Heading</label>
                                <input type="text" name="heading_val" id="heading_val" class="form-control" />
                                <br />
                                <label>Enter Subheading</label>
                                <input type="text" name="subheading" id="subheading" class="form-control" />
                                <br />
                                <label>Enter LOB</label>
                                <input type="text" name="lob" id="lob" class="form-control" />
                                <br />
                            </div>
		...
		<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js"></script>
            ...
            $(document).ready(function(){
                ...
                var dataTable = $('#user_data').DataTable({
                    ...
                    "order":[],
                    "ajax":{
                        url:"functions/business/fetch.php",
                        type:"POST"
                    },
                });
                ...
                $(document).on('submit', '#user_form', function(event){
                    ...
                    var heading = $('#heading_val').val();
                    
                    if(heading != '')
                    {
                        $.ajax({
                            url:"functions/business/insert.php",
                            method:'POST',
                ...
                $(document).on('click', '.update', function(){
                    ...
                    $.ajax({
                        url:"functions/business/fetch_single.php",
                        method:"POST",
                ...
                $(document).on('click', '.delete', function(){
                    ...
                    {
                        $.ajax({
                            url:"functions/business/delete.php",
                            method:"POST",
                            data:{user_id:user_id},
                            success:function(data)
                            {
